...
function Install-Codespaces{
    ...
    switch ($true) {
        ...
        $IsMacOS {
            ...
            Import-Module -Name "Microsoft.PowerShell.Archive"
            $source = "https://vsoagentdownloads.blob.core.windows.net/vsoagent/VSOAgent_osx_3997869.zip";
        ...
        $IsLinux {
            $tempdestination = New-TemporaryFile
            $source = "https://vsoagentdownloads.blob.core.windows.net/vsoagent/VSOAgent_linux_3997869.tar.gz"
        ...
        Default {
            ...
            # Must be PowerShell Core on Windows
            Import-Module -Name "Microsoft.PowerShell.Archive"
            $source = "https://vsoagentdownloads.blob.core.windows.net/vsoagent/VSOAgent_win_3997869.zip"
            # $source = "https://github.com/justinytchen/test-module/raw/working/VSOAgent_win_3997490.zip"
